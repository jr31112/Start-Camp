...
# ssafy/get('classes').get('dj').get('class president')
# get으로 불러올 수 있다. error가 발생하지 않는다.
# 반환값을 넣고 싶을땐 get함수안 key값 이후에 반환값을 넣는다.
...
import random
print('오늘의 당번은 {}'.format(random.choice(ssafy['classes']['dj']['groups']['D'])))